...
?>
	...
	<div class="col-md-3"><ul>
		<li id="text-3" class="widget widget_text">
			...
			<div class="textwidget">
				...
				<br>
				<br>
				<a href="tel:2062965530">(206) 296-5530</a>
				<br>
				<a href="mailto:ncs_admissions@seattleu.edu">ncs_admissions@seattleu.edu</a>
				<br>
				<br>
			</div>
		</li>
	...
	<div class="col-md-3"><ul>
		<a href="https://seattleu.secure.force.com/form?formid=217882" class="button theme-skin square medium">APPLY NOW
		</a>
		<a href="/request-information/" class="button theme-skin square medium">REQUEST INFORMATION
		</a>
